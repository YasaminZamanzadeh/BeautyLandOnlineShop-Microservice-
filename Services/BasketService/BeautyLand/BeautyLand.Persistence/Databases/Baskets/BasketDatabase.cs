...
namespace BeautyLand.Persistence.Databases.Basket
{
    public class BasketDatabase : DbContext, IBasketDatabaseService
    {
        public BasketDatabase(DbContextOptions<BasketDatabase> options) : base(options)
        {
