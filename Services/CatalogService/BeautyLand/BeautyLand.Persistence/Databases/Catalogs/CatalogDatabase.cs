...
{
    public class CatalogDatabase : DbContext, ICatalogDatabaseService
    {
        public CatalogDatabase(DbContextOptions<CatalogDatabase> options) : base(options)
        {

        }
        public DbSet<Item> Items { get; set; }
        public DbSet<Type> Types { get; set; }
        DatabaseFacade ICatalogDatabaseService.Database { get; set; }
